...
impl McpTool for Tool {
    fn definition(&self) -> ToolDefinition {
        ...
        ToolDefinition {
            ...
            description: "ADR-0006 BeforeRun hook — fires when a run contract activates, before any tool use or model emission. Authority: Observe. Trust ceiling: Reviewed.".into(),
