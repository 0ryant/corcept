...
impl McpTool for Tool {
    fn definition(&self) -> ToolDefinition {
        ...
        ToolDefinition {
            ...
            description: "ADR-0006 BeforeSubprocessSpawn hook — fires before a tool implementation invokes Command::new / execve. Authority: Observe. Trust ceiling: Reviewed.".into(),
