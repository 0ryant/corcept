...
impl McpTool for Tool {
    fn definition(&self) -> ToolDefinition {
        ...
        ToolDefinition {
            ...
            description: "ADR-0006 AfterFileWrite hook — fires after a write completes. Authority: Observe. Trust ceiling: Reviewed. Hook input JSON: AfterFileWriteInput (path, bytes_written, sha256).".into(),
