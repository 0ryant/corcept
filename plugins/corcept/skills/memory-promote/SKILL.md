---
description: Promote an evidence-backed memory candidate into accepted memory.
...
Promote a memory candidate only when evidence and explicit approval exist. Do not silently promote observations.
