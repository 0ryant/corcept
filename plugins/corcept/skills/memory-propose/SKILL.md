---
description: Create an evidence-backed memory candidate.
...
Create a candidate memory only. Include title, claim, scope, evidence, confidence, expiry, reason_for_reuse, and risk_if_wrong.
